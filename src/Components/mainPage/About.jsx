    ...
    <>
      <div className="row mb-5 border-bottom border-light border-3 pb-5">
        <div className="col-md-5 col-sm-12">
          ...
          <article>
            <div className="my-4">
              <p className="fw-lighter fst-italic">I love answers!</p>
            </div>
            <div className="my-4">
              <p className="fst-italic">
                ...
                application performance by 14%. Created data visualization tools
                and integrated designs. Increased speed of product lifecycle and
                100% of the time delivered projects within deadline.
              </p>
            </div>
            <div>
              <p className="fst-italic">
                My name is Chamberlain Ezigbo. passionate about creating
                community within the tech space, And a passionate software
                engineer who will do whatever it takes to find an answer.
              </p>
            </div>
            <div>
              <p className="fst-italic">
